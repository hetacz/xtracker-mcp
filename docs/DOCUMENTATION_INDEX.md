...
### `TELEGRAM_FALLBACK.md`

- `/tg/fetch` and MCP parameter contract
- Exact pre-filter `n=1000` behavior
- Raw Telegram metadata schema
- External-reply removal and self-reply retention
- Snowflake-derived 15-minute bucketing
- UTC comparison results and unavailable repost interpretation
